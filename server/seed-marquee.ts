...
export const MARQUEE_CONDOS: MarqueeCondo[] = [
  ...
  // ---------- 11 condos imported from luxuryhomescalgary.ca ----------
  {
    ...
    tagline: "Heritage redevelopment in South Calgary's most-storied school building.",
    intro: [
      "The Residences of King Edward transformed Calgary's historic 1912 King Edward School into a one-of-a-kind boutique condominium in the South Calgary / Marda Loop area. The original sandstone facade, arched windows, and corridor proportions were preserved while the interior was rebuilt as luxury loft-style residences.",
    ],
    residencesCopy: [
      "Lofts and full-floor residences with original sandstone walls, soaring ceilings, and contemporary finishes — quartz counters, integrated appliances, and oversized windows reading the heritage school proportions.",
    ],
    architecturalCopy: [
      "A landmark adaptive-reuse project — Calgary's most prominent designation-protected school converted into a 21st-century residence. The cklSITE redevelopment also added cSPACE, a creative arts centre.",
    ],
    amenities: ["Heritage character preservation", "Underground parking", "Landscaped courtyard", "Bike storage", "Secure entry", "Adjacent cSPACE arts hub"],
    address: "1721 29 Avenue SW, Calgary, AB",
    neighbourhoodSlug: "south-calgary",
    neighbourhood: "South Calgary / Marda Loop",
    quadrant: "city-centre",
    units: 41,
    stories: 4,
    builtIn: 2017,
    developer: "Arts Commons / cSPACE Projects",
    lat: 51.0247,
    lng: -114.0925,
  ...
  },
  {
    slug: "princeton-hall",
    name: "Princeton Hall",
    tagline: "Quiet luxury at the western edge of downtown, fronting Princeton's Landing park.",
    intro: [
      "Princeton Hall is a low-rise luxury condominium on Princeton Way SW in downtown Calgary's West End. Six stories of premium residences directly fronting Princeton's Landing — a small green park linking to the Bow River pathway.",
    ],
    residencesCopy: [
      "Spacious one and two-bedroom residences with private terraces, hardwood floors, gas fireplaces, and chef-grade kitchens. Many homes capture downtown skyline or river views.",
    ],
    architecturalCopy: [
      "Restrained sandstone-and-glass exterior built to integrate with the established West End character. Lower-density profile distinguishes it from the surrounding high-rise towers.",
    ],
    amenities: ["Concierge", "Underground heated parking", "Visitor parking", "Bike storage", "Adjacent park access", "Secure entry"],
    address: "618 Princeton Way SW, Calgary, AB",
    neighbourhoodSlug: "downtown-west-end",
    neighbourhood: "Downtown West End",
    quadrant: "city-centre",
    units: 36,
    stories: 6,
  ...
  },
  {
    ...
    tagline: "The signature address inside Mahogany's Westman Village master-planned community.",
    intro: [
      "Reflection is the residential centrepiece of Westman Village, the master-planned lakeside community by Jayman BUILT in Mahogany. Three connected mid-rise buildings encircle a central indoor amenity space, with direct access to Mahogany Lake's beach and pathway.",
    ],
    residencesCopy: [
      "One and two-bedroom condominiums with extensive amenity floors. Interiors feature quartz counters, premium appliances, and large balconies. Layouts emphasize natural light and views over the Mahogany wetlands.",
    ],
    architecturalCopy: [
      "Three interconnected six-story buildings designed to share a 40,000+ sqft Village Centre amenity hub — pool, fitness, theatre, art studios, and more — accessible without leaving the building.",
    ],
    amenities: ["Indoor saltwater pool", "Fitness centre", "Theatre room", "Art studio", "Wine room", "Private dining", "Direct beach access (Mahogany Lake)", "Underground parking"],
  ...
  },
  {
    slug: "the-montana",
    name: "The Montana",
    tagline: "Established Beltline mid-rise on 17th Avenue SW.",
    intro: [
      "The Montana is a long-established luxury mid-rise on 17th Avenue SW in Calgary's Beltline — a step away from the city's premier dining and retail strip.",
    ],
    residencesCopy: [
      "Generous one and two-bedroom layouts with floor-to-ceiling windows, hardwood floors, and gas fireplaces. Most units have private balconies overlooking 17th Avenue or quieter side streets.",
    ],
    architecturalCopy: [
      "Sleek brick-and-glass tower fitted to the Beltline character, with retail at street level and residences above.",
    ],
  ...
  },
  {
    ...
    name: "Princes Island Estates",
    tagline: "Eau Claire's most discreet address, paired with the Bow River pathway.",
    intro: [
      "Princes Island Estates is a low-density luxury condominium in Eau Claire, just north of downtown Calgary. The building's name reflects its proximity to Prince's Island Park — Calgary's most beloved urban green space — directly across 1st Street SW.",
    ],
    residencesCopy: [
      "Spacious estate-sized residences (often two-bedroom + den or larger) with multiple terraces, gas fireplaces, premium appliances, and direct elevator access on most floors.",
    ],
    architecturalCopy: [
      "Restrained mid-rise massing in sandstone and brick, designed to integrate with the historic Eau Claire neighbourhood and the riverbank's mature canopy.",
    ],
    amenities: ["Concierge", "Underground heated parking", "Direct elevator access", "Storage lockers", "Adjacent to Prince's Island Park", "Bow River pathway access"],
    ...
    lat: 51.0537,
    lng: -114.0716,
    heroImage: "/condo-heroes/princes-island-estates.png",
    sortOrder: 26,
    featured: true,
  },
  {
    slug: "the-views",
    name: "The Views",
    tagline: "Twin Eau Claire towers with full-height river and downtown views.",
    intro: [
      "The Views is a pair of luxury residential towers in Eau Claire, designed to capture both Bow River views to the north and downtown skyline views to the south. Long considered one of Calgary's premier riverfront addresses.",
    ],
    residencesCopy: [
      "Large one, two, and three-bedroom plans with full-height windows, hardwood floors, gas fireplaces, and large balconies. Penthouse residences span up to 4,000+ sqft.",
    ],
    architecturalCopy: [
      "Twin glass-clad towers, each over 25 stories, paired on the same parcel and oriented to maximize daylight and view corridors in every direction.",
    ],
    ...
    address: "1100 8 Avenue SW, Calgary, AB",
    neighbourhoodSlug: "eau-claire",
    neighbourhood: "Eau Claire",
    quadrant: "city-centre",
    units: 220,
  ...
  },
  {
    slug: "covenant-house",
    name: "Covenant House",
    tagline: "Heritage adaptive reuse in the Mission corridor.",
    intro: [
      "Covenant House is a boutique conversion of a historic Mission-area building into a small collection of luxury residences. The project preserved the building's heritage masonry and original window proportions while inserting fully modern interiors.",
    ],
    residencesCopy: [
      "A small portfolio of large, full-floor and half-floor residences with original masonry feature walls, hardwood floors, premium kitchens, and oversized terraces.",
    ],
    architecturalCopy: [
      "An exemplar adaptive-reuse project — original red-brick exterior preserved with modern interventions limited to roof terraces and ground-floor improvements.",
    ],
    amenities: ["Heritage masonry preserved", "Private terraces", "Underground parking", "Secure entry", "Storage lockers"],
    address: "1731 7 Street SW, Calgary, AB",
    neighbourhoodSlug: "lower-mount-royal",
    neighbourhood: "Lower Mount Royal",
    quadrant: "city-centre",
    units: 12,
    stories: 4,
    builtIn: 2014,
    ...
    lat: 51.0376,
    lng: -114.0806,
    heroImage: "/condo-heroes/covenant-house.png",
    sortOrder: 28,
    featured: true,
  },
  {
    slug: "lincoln",
    name: "Lincoln",
    tagline: "Modern boutique condo on 14th Street SW, west of the core.",
    intro: [
      "Lincoln is a contemporary mid-rise condominium on 14th Street SW, situated between the Beltline and downtown's West End. Designed to slot into the rapidly densifying corridor with a modern but understated architectural language.",
    ],
    residencesCopy: [
      "Open-plan one and two-bedroom layouts with floor-to-ceiling windows, quartz counters, and integrated appliances. Many units have city views or quieter west-facing exposures.",
    ],
    architecturalCopy: [
      "A 12-story brick-and-glass building with vertical fenestration emphasizing the slender profile. Street-level activation with townhouse-style ground floor units.",
    ],
    amenities: ["Concierge", "Fitness facility", "Underground heated parking", "Visitor parking", "Bicycle storage", "Pet-friendly"],
    address: "1234 14 Street SW, Calgary, AB",
    neighbourhoodSlug: "downtown-west-end",
    neighbourhood: "Downtown West End",
    quadrant: "city-centre",
    units: 90,
  ...
  },
  {
    slug: "arriva",
    name: "Arriva",
    tagline: "Beltline modern landmark with twin slim towers and full-glass facades.",
    intro: [
      "Arriva is a contemporary luxury condo development in Calgary's Beltline, defined by its twin slim residential towers and full-glass facades. One of the most architecturally distinctive new buildings south of the railway line.",
    ],
    residencesCopy: [
      "Open-plan one and two-bedroom residences with floor-to-ceiling windows, integrated appliances, quartz counters, and private balconies. Higher-floor units offer unobstructed downtown skyline views.",
    ],
    architecturalCopy: [
      "Twin slim towers with full-glass curtain walls — one of the most refined contemporary residential designs in the Beltline.",
    ],
    ...
    address: "1107 1 Street SW, Calgary, AB",
    neighbourhoodSlug: "beltline",
    neighbourhood: "Beltline",
    quadrant: "city-centre",
    units: 285,
  ...
  },
  {
    ...
    address: "550 Riverfront Avenue SE, Calgary, AB",
