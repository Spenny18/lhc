...
// Zones used to group neighbourhoods on the public /neighbourhoods page.
// Same idea as how /condos groups by neighbourhood. Display labels are picked
...
interface MarqueeNeighbourhood {
  ...
  /** Display zone for the /neighbourhoods page grouping. */
  zone: NeighbourhoodZone;
...
export const MARQUEE_NEIGHBOURHOODS: MarqueeNeighbourhood[] = [
  ...
  // ============================================================
  // 40 NEW NEIGHBOURHOODS — added {date}
  // Skeleton entries with sensible defaults. Spencer can flesh out
  // story / amenities / school lists / hero images via the admin
  // CMS at /admin/neighbourhoods (coming soon) or by editing the db
  // directly. Seed is insert-if-missing so admin edits are safe.
  // ============================================================
  {
    slug: "bankview",
    name: "Bankview",
    tagline: "Hilltop inner-city character with downtown skyline views.",
    story: [
      "Bankview is a hillside inner-city neighbourhood directly south of 17 Avenue SW, known for its quiet residential streets, character homes, and panoramic skyline views from the upper terraces. Tight-knit community with strong walkability to the Beltline.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "parkhill",
    name: "Parkhill",
    tagline: "Quiet riverside enclave south of Mission, paired with the Elbow River.",
    story: [
      "Parkhill sits on the south bank of the Elbow River directly across from Mission. The neighbourhood blends mature single-family homes, infill duplexes, and a handful of boutique condo buildings — all minutes from 4 Street SW dining and the river pathway.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "mount-pleasant",
    name: "Mount Pleasant",
    tagline: "Established NW inner-city community along Centre Street.",
    story: [
      "Mount Pleasant is one of Calgary's oldest neighbourhoods, anchored by Confederation Park and Confederation Golf Course. A mix of mid-century bungalows, modern infills, and quiet residential streets directly north of downtown.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "rosedale",
    name: "Rosedale",
    tagline: "Premier NW inner-city address paired with Crescent Heights and McHugh Bluff.",
    story: [
      "Rosedale is one of Calgary's most desirable inner-city neighbourhoods, perched on the north-side bluff with sweeping downtown views from McHugh Bluff. A mix of heritage mansions, modern infills, and tightly-held estate homes.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    ...
    tagline: "Quiet NW family enclave next to the Foothills Hospital and U of C campus.",
    story: [
      "St. Andrews Heights is a tightly-held NW inner-city community surrounded by Foothills Hospital, the U of C campus, and the Edworthy Park escarpment. Mid-century homes on generous lots dominate, with newer infill in choice locations.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    ...
    tagline: "Hillside NW inner-city paired across the SAIT/ACAD ridge.",
    story: [
      "Hounsfield Heights and Briar Hill share a single community association and sit on the elevated ridge directly above SAIT and the Foothills Hospital corridor. Mature trees, downtown skyline views, and tight access to Kensington and the LRT.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "parkdale",
    name: "Parkdale",
    tagline: "Bow River-front NW inner-city paired with Edworthy Park.",
    story: [
      "Parkdale sits along the Bow River pathway between Kensington and Edworthy Park. Mid-century bungalows and modern infills coexist on quiet streets steps from the river, the Foothills Athletic Park, and Memorial Drive into downtown.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "south-calgary",
    name: "South Calgary",
    tagline: "Marda Loop's quieter residential half — established inner-city with character homes.",
    story: [
      "South Calgary covers the residential blocks east of Marda Loop's commercial strip. A walkable, family-friendly inner-city neighbourhood with character bungalows, modern infills, and quick access to 14th Street and Crowchild Trail.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "richmond",
    name: "Richmond",
    tagline: "Marda Loop-adjacent inner-city paired with Knob Hill.",
    story: [
      "Richmond sits between Marda Loop's restaurant strip and Crowchild Trail. A mix of post-war bungalows, modern infills, and pockets of heritage character — minutes from Mount Royal University and the river pathway.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "kelvin-grove",
    name: "Kelvin Grove",
    tagline: "Quiet south-of-Glenmore family enclave between Chinook and Heritage.",
    story: [
      "Kelvin Grove is a tightly-held south-side family neighbourhood between Macleod Trail and 14 Street SW. Mature trees, mid-century bungalows on generous lots, and easy access to Chinook Centre and the Heritage LRT station.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "windsor-park",
    name: "Windsor Park",
    tagline: "Britannia-adjacent established inner-city.",
    story: [
      "Windsor Park sits between Britannia and Elbow Drive, one of Calgary's most stable established inner-city neighbourhoods. Renovated bungalows, mature elms, and walkable to Britannia Plaza's restaurants and shops.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "elboya",
    name: "Elboya",
    tagline: "Quiet inner-city Elbow River escarpment community.",
    story: [
      "Elboya is a small, tightly-held inner-city community on the south side of the Elbow River escarpment, paired with Britannia and Windsor Park. Treed streets, mid-century homes on large lots, and direct access to the river pathway.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    ...
    tagline: "Pocket inner-city community south of the Elbow River.",
    story: [
      "Meadowlark Park is a small inner-city pocket of mid-century homes south of the Elbow River, between Mission and Chinook. Quiet, walkable, and increasingly sought-after by buyers wanting inner-city access without the Mission price tag.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "ramsay",
    name: "Ramsay",
    tagline: "East-side hilltop community with heritage character + downtown views.",
    story: [
      "Ramsay sits on the bluff directly east of downtown, paired with Inglewood and the Stampede grounds. Heritage workers' cottages, modern infills, and one of the best skyline view corridors in the city.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "edgemont",
    name: "Edgemont",
    tagline: "Family-focused NW community with John Laurie Boulevard ridgeline views.",
    story: [
      "Edgemont is a large NW family community wrapped around Nose Hill Park's western edge. Mid-1980s estates and contemporary builds, with strong schools and direct trails into Nose Hill.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "hamptons",
    name: "Hamptons",
    tagline: "Golf-course community at the NW edge of Calgary.",
    story: [
      "The Hamptons is a 1990s NW family community built around the Hamptons Golf Club. Wide curving streets, executive single-family homes, and quick Crowchild access into downtown or Stoney Trail to the airport.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    ...
    name: "Varsity Estates",
    tagline: "Established NW community paired with the U of C and Bow River escarpment.",
    story: [
      "Varsity Estates is the upper-tier portion of Varsity, perched on the Bow River escarpment between the U of C and Market Mall. Mid-century estates on generous lots, with walking access to Bowmont Park and the river.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "evanston",
    name: "Evanston",
    tagline: "Newer NW family community north of Stoney Trail.",
    story: [
      "Evanston is a 2000s/2010s family community in Calgary's far NW, north of Stoney Trail. Modern single-family homes, walkable parks, and strong elementary/middle school catchments.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "elbow-valley",
    name: "Elbow Valley",
    tagline: "Acreage-style estate community west of Calgary along the Elbow River.",
    story: [
      "Elbow Valley is one of Calgary's premier estate communities, set along the Elbow River just west of city limits. Custom luxury homes on landscaped lots with private trails, ponds, and a strong country-club feel within minutes of West Calgary.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    ...
    tagline: "Newer estate development west of the original Elbow Valley community.",
    story: [
      "Elbow Valley West extends the Elbow Valley estate community further west into Springbank-area parcels. Newer custom luxury builds on larger lots with mountain views and direct access to the original Elbow Valley amenities.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "lakeview",
    name: "Lakeview",
    tagline: "Established west-side family community paired with Glenmore Reservoir.",
    story: [
      "Lakeview sits directly above the Glenmore Reservoir on Calgary's west side. Mid-century bungalows on large lots, mature trees, and instant access to the reservoir pathway, North Glenmore Park, and the Earl Grey Golf Club.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "oakridge",
    name: "Oakridge",
    tagline: "Family community south of Glenmore Reservoir, paired with Heritage Park.",
    story: [
      "Oakridge sits on the south shore of the Glenmore Reservoir, paired with Heritage Park and the Weaselhead Natural Area. Mid-1970s family homes, walkable to the reservoir pathway and Glenmore Landing shops.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "signal-hill",
    name: "Signal Hill",
    tagline: "West-side hillside family community with mountain views.",
    story: [
      "Signal Hill is a hillside family community on Calgary's west side, paired with Westhills shopping centre. Wide-set single-family homes, walking-distance to Battalion Park, and direct Bow Trail access into downtown.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    ...
    tagline: "Reservoir-side west-side community.",
    story: [
      "North Glenmore Park sits between Lakeview and Mount Royal University, directly above the Glenmore Reservoir's north shore. Mid-century family homes with quiet streets, paired with the reservoir pathway and Heritage Park access.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "wildwood",
    name: "Wildwood",
    tagline: "Quiet west-side enclave paired with Edworthy Park.",
    story: [
      "Wildwood is a tightly-held west-side enclave paired with Edworthy Park, the Bow River pathway, and Spruce Cliff. Mid-century bungalows, large lots, and direct trails into the Douglas Fir Trail and Edworthy Park.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "woodbine",
    name: "Woodbine",
    tagline: "South-side family community paired with Fish Creek Park.",
    story: [
      "Woodbine is a south-side family community at the western edge of Fish Creek Park. Mid-1980s/1990s single-family homes with direct Fish Creek pathway access and quick southwest commuter routes.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "canyon-meadows",
    name: "Canyon Meadows",
    tagline: "Established south-side family community paired with Fish Creek Park.",
    story: [
      "Canyon Meadows is one of Calgary's most established south-side family neighbourhoods, paired directly with Fish Creek Park. Mid-1970s homes on generous lots, walking distance to Fish Creek pathways and the Canyon Meadows LRT station.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "willow-park",
    name: "Willow Park",
    tagline: "Established south-side family community + golf course.",
    story: [
      "Willow Park sits between Macleod Trail and Bow Bottom Trail, anchored by the Willow Park Golf & Country Club. Mid-century single-family homes on large lots, paired with Trico Centre and Southland Leisure Centre.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "lake-bonavista",
    name: "Lake Bonavista",
    tagline: "Calgary's first lake community, established in 1967.",
    story: [
      "Lake Bonavista is Calgary's first private lake community, built around a 52-acre freshwater lake with private beaches, swimming, and skating. Mid-century single-family homes alongside modern rebuilds, with deep family roots and tight-knit lake community culture.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "chaparral",
    name: "Chaparral",
    tagline: "South-side lake community paired with Fish Creek Park's eastern edge.",
    story: [
      "Chaparral is a south-side lake community on Calgary's far south edge, with private Lake Chaparral access and direct Fish Creek Park pathway connections. Mid-2000s family homes with strong school catchments.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "cranston",
    name: "Cranston",
    tagline: "Master-planned SE family community paired with the Bow River escarpment.",
    story: [
      "Cranston is a 2000s master-planned SE community spanning the Bow River escarpment, paired with Cranston's Riverstone (luxury) and Fish Creek Park access. Strong K-9 catchments, modern single-family homes, and the Century Hall amenity centre.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "alpine-park",
    name: "Alpine Park",
    tagline: "Newest SW master-planned community by Dream + Qualico.",
    story: [
      "Alpine Park is one of Calgary's newest SW master-planned communities, set on rolling foothills land south of Stoney Trail. Modern single-family homes with mountain views, designed-in trail networks, and a planned village commercial core.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "harmony",
    name: "Harmony",
    tagline: "Master-planned acreage-feel community west of Calgary on Springbank land.",
    story: [
      "Harmony is a Bordeaux Developments master-planned community west of Calgary on Springbank Road, paired with two private lakes, the Mickelson National Golf Club, and direct Rocky Mountain views. Custom luxury homes on premium lots.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "watermark",
    name: "Watermark",
    tagline: "Bearspaw NW estate community with private gates + trails.",
    story: [
      "Watermark at Bearspaw is a gated estate community in the Bearspaw foothills NW of Calgary. Custom luxury homes on landscaped lots with private water features, walking trails, and mountain views — minutes from Stoney Trail into the city.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    slug: "pine-creek",
    name: "Pine Creek",
    tagline: "Newer SE family community paired with Pine Creek pathway and Stoney Trail.",
    story: [
      "Pine Creek is one of Calgary's newest south-side family communities, paired with the Pine Creek Valley pathway system and direct Stoney Trail access. Modern single-family homes with strong school catchments and proximity to Spruce Meadows.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
  ...
  },
  {
    ...
    tagline: "Acreage-style estate community + golf, just south of Calgary in Foothills MD.",
    story: [
      "Heritage Pointe is a 30-year-old estate + golf community in the Foothills MD directly south of Calgary, paired with the Heritage Pointe Golf Club. Custom luxury homes on country-residential parcels — quiet, mature, and minutes from south Calgary commuter routes.",
    ],
    outsideCopy: [],
    amenitiesCopy: [],
    shopDineCopy: [],
